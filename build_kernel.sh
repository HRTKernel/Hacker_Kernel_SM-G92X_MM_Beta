...
{	
	...
	if [ -e $BUILD_KERNEL_DIR/arch/arm64/boot/Image ]; then
	      ...
	      chmod 0755 ./build_image/zip_files/system/lib/modules/*
	      #${CROSS_COMPILE}strip --strip-debug ./build_image/zip_files/system/lib/modules/*.ko
	      #${CROSS_COMPILE}strip --strip-unneeded /build_image/zip_files/system/lib/modules/*
